...
## How To Add New Collections And Instruments
   ...
   1. A developer will create a `<collection>2caom2` github project using the [blank](https://github.com/opencadc/blank2caom2.git) template project.
   ...
   1. Together, a developer and an astronomer will evaluate what software is required for this pipeline:
      1. whether apps or methods already exist in [caom2pipe](https://github.com/opencadc/caom2pipe.git), or new software must be created,
...
As part of the CDEP, the following will be enforced:
   ...
   1. The Python packages are described [here](https://github.com/opencadc/collection2caom2#the-strategy-being-used).
